...
function getCardData(i) {
  ...
  let pokemonImage =
    loadedPokemon[i]["sprites"]["other"]["dream_world"]["front_default"];
    ...
    <div id="${i}" class="pokemon-detail">
        ...
        <div class="card-background" style="background: ${
          cardData.background
            ...
            <img id="pokemon_image_card" class="lg-img img-pos-card" src="${
              cardData.pokemonImage
            }" alt="">
            <div class="type">
                <img id="type_img_card" class="type-img" src="./img/icons/${
